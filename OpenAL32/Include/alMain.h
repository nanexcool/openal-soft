...
// Update buffer size was requested by the app or config file
#define DEVICE_UPDATE_SIZE_REQUEST               (1<<5)
// Update buffer count was requested by the app or config file
#define DEVICE_UPDATE_BUFFERS_REQUEST            (1<<6)
